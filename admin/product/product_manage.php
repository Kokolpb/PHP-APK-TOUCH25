        ...
        <tr>
          ...
          <td colspan="2" align="center"><table width="95%" border="0" cellspacing="0" cellpadding="0"  id="otable">
		   ...
		   <?php for($i=0;$i<$intNews;$i++) {
            ...
            <? if($picone[opicname]!=''){?>
            <a href="javascript:void(0)"  onclick="$.wholepop.dialogClass ='style_1';poppic('<?php echo $siteurl;?>/upload/product/<?php echo $picone[opicname];?>','Product Overview','<?php echo $picone[id_prodpic];?>');"> <img src="/upload/product/<?php echo $picone[opicname];?>" width="40" height="40" border="0" /></a>
            <? }else{?>
            <a href="javascript:void(0)"  onclick="needupfile(<?php echo $arrproductinfos[$i][id_prodinfo];?>,'../../upload/product/','|jpg|jpeg|gif|png','/admin/product/ajax_upfileindata.php');"> 
