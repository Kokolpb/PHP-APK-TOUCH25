...
$arr[info].='<div class="productWrapper img_gradient  clearfix "><div class="thumb pam"><a class="return_true" href="/product/productview.php/'.$arrproducts[$i][pid].'/'.$arrproducts[$i][id_proddir].'/.html"><img src="/upload/product/'.$getpic.'" alt=""></a></div><div class="thumbInfo mvs" style="220px"><a href="/product/productview.php/'.$arrproducts[$i][pid].'/'.$arrproducts[$i][id_proddir].'/.html" class="newsName deep_bold_red return_true mtm">'.$arrproducts[$i][title].'<p class="prod_model_num pvs">'.$arrproducts[$i][intro].'</p></a></div></div><hr class="wapOnly">';
