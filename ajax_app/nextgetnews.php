...
$arr[info].='<div class="productWrapper img_gradient  clearfix " style=" padding-left:5px;"><div class="thumbInfo mvs" style="width:100%;"><a  href="javascript:void(0)"  onclick="gonewsview(\'newsview.html\','.$arrnews[$i][id].','.$arrnews[$i][id_newsdir].',\'\')" class="newsName deep_bold_red return_true mtm">'.$arrnews[$i][title].'<p class="mbm">'.$arrnews[$i][intro].'</p></a></div></div>';
