...
$siteurl="http://demo-8.8800.org:6003";//必设 后面涉及图片路径 ajax_app目录远程图片需要此变量
...
$strSQL = "select iscopy,otherheader,title,keywords,description,bannertime,mapcode,statistics,weburl,newsnum,productnum,rmailbox as email,smailbox as tel  from siteset where id_siteset=1" ;
$objDB->Execute($strSQL);
$setinfo=$objDB->fields();



if($_SERVER["REMOTE_ADDR"]!='101.85.57.216' ){
/*IS MOBI*/
